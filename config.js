...
global.ownername = process.env.OWNER_NAME === undefined ? "👿𝗗𝗨𝗠𝗜𝗬𝗔⃤𝗕𝗢𝗬🇱🇰" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94771901094' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
